...
<body>
      ...
      <!-- header -->
        ...
        <div id="wrapper">
            ...
            <!-- content-->
            <form id="content" method="post" action="../join.do" onsubmit="return joinCheck(this)">
        ...
        <!--         PW2
               ...
               <!--  <div>
                    ...
                    <div id="bir_wrap">
                        ...
                        <div id="bir_yy">
                            <span class="box">
                                <input type="text" id="yy" class="int" maxlength="4" placeholder="년(4자)" name="birthYear">
                            </span>
                        </div>
 ...
 -->
                ...
                <div>
                    ...
                    <span class="box int_email">
                        <input type="email" id="email" class="int" maxlength="100" name="email">
                    </span>
           ...
           <!--      <div>
                ...
                <!-- MEMBER_TYPE -->
			<div>
                    <h3 class="join_title"><label for="memberType">회원구분</label></h3>
                    <span class="box memberType_code">
                        <select id="memberType" class="sel" name="mem_class">
                            <option>구분</option>
                            <option value="n">일반 회원</option>
                            <option value="t">트레이너 회원</option>
...
<!--                <div>
                    <h3 class="join_title">
                        <label for="registNumber">등록번호</label>
                    </h3>
                    <span class="box int_id">
                        <input type="text" id="id" class="int" maxlength="100" placeholder="사업자번호 / 트레이너협회 자격증번호">
                        <span class="step_url"></span>
                    </span>
                    <span class="error_next_box">필수 정보입니다.</span>
               </div>     
