...
<%
	...
	try{
		...
		String awards = mr.getParameter("awards");
		...
		request.setAttribute("errorMessage", "아마도 파일 업로드 오류");
		request.getRequestDispatcher("TrainerCenterForm.jsp").forward(request, response);
	}
