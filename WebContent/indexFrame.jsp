...
<head>
    ...
    <style>
        ...
        @font-face {
            font-family: "jua";
            src: url("search/fonts/BMJUA_ttf.ttf");
        }
...
<body>
    ...
    <header>
        <nav id="cf_main_header">
            <a id="cf_logo" href="index.jsp"><img src="search/images/Logo.jpg" alt="로고" width="200px" height="100px"></a>
            ...
            <div id="cf_main_gnb">
                <ul>
                    <li><a href="search/SearchPage.jsp">검색</a></li>
                    <li><a href="#">커뮤니티</a></li>
                </ul>
            </div>
            <div id="cf_main_lnb">
                <ul>
                    <li><a id="cf_main_lnb1" href="search/login.jsp">로그인</a></li>
                    <li><a id="cf_main_lnb2" href="search/joinEx.jsp">회원가입</a></li>
                </ul>
            </div>
        </nav>
    </header>
